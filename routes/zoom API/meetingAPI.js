  ...
  rp(options)
    .then(function (response) {
      ...
      let dataRes = {
        ...
        join_url: `https://zoom-sdk-95925.web.app/nav.html?/mn=${
          response.id
        }?pwd=${response.encrypted_password}?role=${0}?name=`,
        // join_url_react: `http://localhost:3000/nav.html?/mn=${
        //   response.id
...
// if we want use webinars we should subscribe for zoom webinar
